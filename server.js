...
// Middleware
const allowedOrigins = ['https://inventory-management-frontend-rosy.vercel.app', 'http://localhost:3000' , 'https://inventory-management-frontend-3id3v128e-manish-vms-projects.vercel.app'];
app.use(cors({
