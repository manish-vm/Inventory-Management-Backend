...
// Middleware
const allowedOrigins = ['https://inventory-management-frontend-rosy.vercel.app', 'http://localhost:3000' , 'https://inventory-management-frontend-hjytk8jul-manish-vms-projects.vercel.app'];
app.use(cors({
